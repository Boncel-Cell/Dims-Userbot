...
# untuk perintah .dims
DIMS_TEKS_KUSTOM = os.environ.get("DIMS_TEKS_KUSTOM", None)
...
# Default .alive logo
ALIVE_LOGO = os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/ade26e0938de8b3fa8a9d.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```Dims-Userbot Telah Aktif💩```")
    return
